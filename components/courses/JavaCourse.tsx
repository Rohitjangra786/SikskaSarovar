...
import { CheckCircle2, ArrowRight, ArrowLeft, Play, Copy, Check, Circle, Undo, Coffee, GraduationCap } from 'lucide-react';
import MarkdownRenderer from '../MarkdownRenderer';

interface JavaCourseProps {
    lesson: Lesson;
    course: Course;
...
const JavaCourse: React.FC<JavaCourseProps> = ({
    lesson,
    course,
    completedLessons,
    toggleCompletion,
